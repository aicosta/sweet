...
@section('content')
	<div class="col-md-12">
		<div class="box box-success">
			...
			<form action="/products/clone" role="form" method="post">
			{!! csrf_field() !!}
				<div class="box-body">
					<div class="col-md-4">
						<div class="form-group">
							<label for="sku">SKU</label>
							<input type="text" class="form-control" name="sku" placeholder="SKU comercial do produto" value="">
						</div>
					</div>
					<div class="col-md-8">
						<div class="form-group">
					...
					<div class="col-md-12">
						<div class="form-group">
		                	...
		                	<textarea name="description" id="description" class="form-control" rows="3" placeholder="Descrição principal do produto">{{$product->description}}</textarea>
		                </div>
					</div>
